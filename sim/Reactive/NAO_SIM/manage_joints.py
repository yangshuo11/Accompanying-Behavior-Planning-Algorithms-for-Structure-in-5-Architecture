...
def JointInit(clientID,i,Body):
    for t_id in range(24):
        vrep.simxSetJointTargetPosition(clientID,Body[t_id][i],0,vrep.simx_opmode_streaming)
    #Left Fingers
    for f_id in range(8):
        vrep.simxSetJointTargetPosition(clientID,Body[25][i][0],0,vrep.simx_opmode_streaming)
    #Right Fingers
    for f_id in range(8):
        vrep.simxSetJointTargetPosition(clientID,Body[27][i][0],0,vrep.simx_opmode_streaming)